...
if (WIN32)
  set (XSCT_NAME "xsct.bat")
  set (BOOTGEN_NAME "bootgen.bat")
else ()
  set (XSCT_NAME "xsct")
  set (BOOTGEN_NAME "bootgen")
endif ()

find_program(VITIS_XSCT NAMES ${XSCT_NAME} DOC "Xilinx Vitis XSCT tool")

if (EXISTS ${VITIS_XSCT})
  get_filename_component(VITIS_BIN ${VITIS_XSCT} PATH)
  find_program(VITIS_BOOTGEN NAMES ${BOOTGEN_NAME} HINTS ${VITIS_BIN} DOC "Xilinx Vitis bootgen tool")
  ...
  if (VITIS_XSCT)
    ...
    if (VitisVersionOutput)
      ...
      if (VitisVersionString)
        ...
        message (WARNING "FindVitis: unable to run ${XSCT_NAME} to get version string")
    endif ()
  endif ()
